...
class CLIP(nn.Module):
    def __init__(self,
        ...
        self.token_embedding = nn.Embedding(vocab_size, transformer_width) #token_embedding
    ...
    def encode_text(self, text): 
        ...
        # print("Shape of positional_embedding:", self.positional_embedding.shape)
        # print("Shape of positional_embedding_res:", self.positional_embedding_res.shape)
